...
- ML Kit/AICore app-mode smoke test launched on emulator and captured:
...
- `cd kan-app && flutter test`: pass, 43 tests.
...
Objective: maximize the Gemma 4 Good submission quality for Kan without deploying from this workspace.

Prompt-to-artifact checklist:

| Requirement | Evidence | Status |
|---|---|---|
| Working prototype | `kan-app/`, `submission/live-demo/kan-debug.apk`, `./scripts/verify_submission.sh` | Ready locally |
