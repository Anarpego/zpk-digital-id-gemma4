...
| Public demo files | `submission/dist/kan-demo-package-20260501T172959Z.zip`, static live-demo page, APK, checksums | Ready locally, not uploaded |
...
- Upload `submission/dist/kan-demo-package-20260501T172959Z.zip` to a public no-login URL.
