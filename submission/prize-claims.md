...
- DID-style document, Android Keystore-backed HMAC-SHA256 recovery credential, signed local authentication proof, signed agent execution ledger, signed redacted recovery packet, revocation that blocks later auth proofs, selective disclosure claims, and 15-minute consent proof.
