...
- `kan-demo-package-20260501T181515Z.zip`: APK, static demo page, final video, writeup, evidence, screenshots, and Unsloth scaffold.
...
shasum -a 256 submission/dist/kan-demo-package-20260501T181515Z.zip submission/kan-final-demo-video.mp4 submission/live-demo/kan-debug.apk
```
