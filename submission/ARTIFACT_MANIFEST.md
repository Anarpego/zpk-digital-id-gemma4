...
| Demo package | `submission/dist/kan-demo-package-20260501T172021Z.zip` | Downloadable bundle with APK, video, docs, evidence, and Unsloth scaffold | Generate after final packaging with `shasum -a 256 submission/dist/kan-demo-package-*.zip` |

## Kaggle Form Inputs

- Repository URL: fill in after public GitHub push.
- Live demo URL: fill in after uploading `submission/dist/kan-demo-package-20260501T172021Z.zip`.
...
unzip -l submission/dist/kan-demo-package-20260501T172021Z.zip | rg "\\.env|kan-final-demo-video|training_attempt|kan-debug.apk"
```
