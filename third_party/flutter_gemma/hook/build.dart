...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    if (os == OS.macOS &&
        Platform.environment['ZPK_ENABLE_FLUTTER_GEMMA_MACOS_ASSETS'] !=
            '1') {
      stderr.writeln(
          'flutter_gemma: skipping macOS native assets for ZPK host-side tests. Set ZPK_ENABLE_FLUTTER_GEMMA_MACOS_ASSETS=1 to build a macOS app.');
      return;
    }
